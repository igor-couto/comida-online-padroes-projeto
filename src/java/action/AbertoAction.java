 ...
 * @author fhnri
 */
public class AbertoAction implements Action{
        ...
        if (id.equals("")) {
            ...
            try {
                ...
                if(pedido!=null){
                    ...
                    String m=pedido.getStatus().Aberto(pedido);
                ...
                Logger.getLogger(AbertoAction.class.getName()).log(Level.SEVERE, null, ex);
