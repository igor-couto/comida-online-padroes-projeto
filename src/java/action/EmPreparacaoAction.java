 ...
 * @author fhnri
 */
public class EmPreparacaoAction implements Action{
        ...
        if (id.equals("")) {
            ...
            try {
                ...
                if(pedido!=null){
                    ...
                    String m=pedido.getStatus().EmPreparacao(pedido);
                ...
                Logger.getLogger(EmPreparacaoAction.class.getName()).log(Level.SEVERE, null, ex);
