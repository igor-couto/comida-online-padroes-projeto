 ...
 * @author fhnri
 */
public class CanceladoAction implements Action{
        ...
        if (id.equals("")) {
            ...
            try {
                ...
                if(pedido!=null){
                    ...
                    String m=pedido.getStatus().Cancelado(pedido);
                ...
                Logger.getLogger(CanceladoAction.class.getName()).log(Level.SEVERE, null, ex);
