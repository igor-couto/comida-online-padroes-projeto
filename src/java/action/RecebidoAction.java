 ...
 * @author fhnri
 */
public class RecebidoAction implements Action{
        ...
        if (id.equals("")) {
            ...
            try {
                ...
                if(pedido!=null){
                    ...
                    String m=pedido.getStatus().Recebido(pedido);
                ...
                Logger.getLogger(RecebidoAction.class.getName()).log(Level.SEVERE, null, ex);
